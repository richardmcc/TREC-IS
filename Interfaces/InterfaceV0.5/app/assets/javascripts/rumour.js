	...
	var aNewItem = document.createElement('tr');
        aNewItem.setAttribute("id", identifier);
        	...
        	aNewItem.innerHTML = ""+
        		...
        		"<td>"+lang+"</td>"+
        		"<td>"+doubt+"</td>"+
        		"<td><div class='btn-group' role='group' aria-label='...'><button type='button' id=\"button-"+json.identifier+"\" class='btn btn-primary' onclick='window.open(\"http://localhost:9000/super/wp4/rumourThread?thread="+json.identifier+"\")'>View Thread</button></div></td>";
