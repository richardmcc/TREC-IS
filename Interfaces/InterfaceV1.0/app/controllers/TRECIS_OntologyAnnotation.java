...
import actors.trecis.ontology.OntologyAnnotatorActorV0;
	...
	public static WebSocket<JsonNode> ws() {
		return new WebSocket<JsonNode>() {
			...
			public void onReady(play.mvc.WebSocket.In<JsonNode> in,
				...
				final ActorRef trecisActor = Akka.system().actorOf(Props.create(OntologyAnnotatorActorV0.class, ontologyFile, tweetFile, labelFile, out));
