...
public class TRECIS_TweetGroupAnnotator extends Controller{

	public static String currentAnnotatorID = "";
	public static String currentEventIdentifier = "";
	
	public static Result index(String annotatorID, String identifier) {
		
		currentAnnotatorID = annotatorID;
		currentEventIdentifier = identifier;
		
        return ok(views.html.TRECIS_TweetGroupAnnotator.render());
    }
	...
	public static WebSocket<JsonNode> ws() {
		return new WebSocket<JsonNode>() {
			...
			public void onReady(play.mvc.WebSocket.In<JsonNode> in,
				...
				jsonMessage.put("eventIdentifier", currentEventIdentifier);
